...
class Torrent:
    def __init__(self, torrent) -> None:
        ...
        self.torrent_file = lt.bdecode(open(torrent, "rb").read())
        self.info = lt.torrent_info(self.torrent_file)
        self.save_path = ""
        self.expanded_path = ""
        self.info.save_path = ""
    ...
    def gen_download_stub(self):
        try:
            ...
            session_card = self.session.add_torrent(
                {"ti": self.info, "save_path": self.expanded_path}
            )
